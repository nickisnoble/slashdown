...
describe("renderers", ()=> {
  ...
  test("JSONRenderer produces valid JSON", () => {
    ...
    const expected = '{"type":"root","children":[{"type":"slashdownTag","tagName":"div","children":[{"type":"text","value":"Hello World!","position":{"start":{"line":1,"column":14},"end":{"line":1,"column":14}}}],"classes":["container"],"position":{"start":{"line":1,"column":1},"end":{"line":1,"column":14}}}],"position":{"start":{"line":1,"column":1},"end":{"line":1,"column":1}}}';
